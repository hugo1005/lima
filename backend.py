...
from exchange_sockets import BitstampOrderbook, GlobitexOrderbook, KrakenOrderbook
...
#                         "channel": "live_orders_" + self.ticker
#                     }}))
...
#                             if parsed['event'] == "order_created" or parsed['event'] == "order_deleted" or parsed['event'] == "order_changed":
...
#             qty = float(ask[1])
#             order_id = ask[2]
#             order_data_mod = {'order_id':order_id, 'price':price, 'qty':qty , 'type': 'ASK'}
